...
class CertFactory(object):
    ...
    def new_certnkey(self, cn, cacert_file):
        if cacert_file != None:
            raise NotImplemented()
        else:
            return self.mk_simple_selfsigned_certnkey(cn=cn, country=DEFAULT_X509_C, org=DEFAULT_X509_O)

    def mk_simple_selfsigned_certnkey(self, cn=DEFAULT_X509_CN, country=DEFAULT_X509_C, org=DEFAULT_X509_O):
        '''
